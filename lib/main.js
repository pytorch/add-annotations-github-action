...
function createCheck(check_name, title, annotations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield octokit.checks.listForRef(Object.assign(Object.assign({ check_name }, github.context.repo), { ref: core.getInput('commit_sha') }));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (annotations.length > 0) {
                ...
                yield createCheck(checkName, 'commit_sha', annotations);
